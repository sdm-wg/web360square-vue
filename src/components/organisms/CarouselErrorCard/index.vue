<template>
  <div
    class="w-full h-full bg-white text-red-600 font-bold text-2xl md:text-3xl lg:text-4xl text-center flex justify-center items-center rounded-lg overflow-hidden leading-none"
  >
    <div class="px-4 flex items-center">
      <!-- Warning SVG -->
      <div class="w-12 md:w-24 px-1 md:px-2 flex justify-center items-center">
        <svg
      ...
      <!-- Message -->
      <span class="px-1 md:px-2">Event data not found</span>
    </div>
  </div>
</template>
